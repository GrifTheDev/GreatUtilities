...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        var Waiting = await message.channel.send('**Obtaining Fox Image...**')
                ...
                message.channel.send('', {
                    ...
                    client.on('clickButton', async (button) => {
                        ...
                        if (button.id === 'StarButton' + messageID && button.clicker.user.id === message.author.id) {
                            ...
                            if (favourites[message.author.id].images.includes(` ${res.data.image} `)) {
                            ...
                            favourites[message.author.id].images.push(` ${res.data.image} `)
                            ...
                            button.reply.send(`${client.TickEmoji} This image has been successfully saved to your gallery!`, true)
                            



                            console.log(`Dog image requested by ${message.author.username}: ${res.data.image}`)
